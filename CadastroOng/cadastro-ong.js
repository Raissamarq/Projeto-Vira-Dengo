document.addEventListener('DOMContentLoaded', () => {
  ...
  const form = document.querySelector('.form-cadastro-ong');
  ...
  function mostrarEtapa(numero) {
    ...
    document.querySelector('.form-cadastro-ong').scrollIntoView({ behavior: 'smooth', block: 'start' });
  }
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const emailInstitucional = formData.get('emailinstitucional');
    ...
    try {
      ...
      if (emailConfirmacao && emailInstitucional) {
        emailConfirmacao.textContent = emailInstitucional;
      }
